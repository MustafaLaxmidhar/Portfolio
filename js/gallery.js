  ...
  aus: {
    ...
    photos: {
      black: [
        ...
        { src: "assets/images/photography/aus/Central.jpg", alt: "Central" },
        { src: "assets/images/photography/aus/skylight.jpg", alt: "Skylight" },
        { src: "assets/images/photography/aus/Anzac.jpg", alt: "Anzac" },
        { src: "assets/images/photography/aus/Lizard.jpg", alt: "Lizard" },
        { src: "assets/images/photography/aus/Alpaca.jpg", alt: "Alapca" },
        { src: "assets/images/photography/aus/Bird.jpg", alt: "Bird" },
        { src: "assets/images/photography/aus/Looking.jpg", alt: "Looking" },
        { src: "assets/images/photography/aus/TakeFlight.jpg", alt: "TakeFlight" },
        { src: "assets/images/photography/aus/Cappy.jpg", alt: "Cappy" },
        { src: "assets/images/photography/aus/Clock.jpg", alt: "Clock" },
        { src: "assets/images/photography/aus/Penguin.jpg", alt: "Penguin" },
        { src: "assets/images/photography/aus/Giraffe.jpg", alt: "Giraffe" },
        { src: "assets/images/photography/aus/GiraffeFeed.jpg", alt: "GiraffeFeed" },
        { src: "assets/images/photography/aus/eMu.jpg", alt: "eMu" },
        { src: "assets/images/photography/aus/Meerkat.jpg", alt: "Meerkat" },
        { src: "assets/images/photography/aus/Roo.jpg", alt: "Roo" },
        { src: "assets/images/photography/aus/Cathedral.jpg", alt: "Cathedral" },
        { src: "assets/images/photography/aus/StainedGlass.jpg", alt: "StainedGlass" },
        { src: "assets/images/photography/aus/Stone.jpg", alt: "Stone" },
        { src: "assets/images/photography/aus/Plates.jpg", alt: "Plates" },
        { src: "assets/images/photography/aus/Glass.jpg", alt: "Glass" },
        { src: "assets/images/photography/aus/Tailor.jpg", alt: "Tailor" },
        { src: "assets/images/photography/aus/Fair.jpg", alt: "Fair" },
        { src: "assets/images/photography/aus/Ferris.jpg", alt: "Ferris" },
        { src: "assets/images/photography/aus/Luna.jpg", alt: "Luna" },
        { src: "assets/images/photography/aus/FlagnCrate.jpg", alt: "FlagnCrate" },
        { src: "assets/images/photography/aus/Bondi.jpg", alt: "Bondi" },
        { src: "assets/images/photography/aus/GeoffJamesPool.jpg", alt: "GeoffJamesPool" },
        { src: "assets/images/photography/aus/Rocks.jpg", alt: "Rocks" },
        { src: "assets/images/photography/aus/Manly.jpg", alt: "Manly" },
        { src: "assets/images/photography/aus/Icebergs.jpg", alt: "Icebergs" },
        { src: "assets/images/photography/aus/Gull.jpg", alt: "Gull" },
